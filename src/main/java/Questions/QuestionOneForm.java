...
public class QuestionOneForm extends javax.swing.JFrame {
    ...
    private boolean VerifyResponses(String response) {
        ArrayList responseList = new ArrayList<String>();
        responseList.add(response);
        Questions question = new Questions("maça",responseList);
        if(question.verifyResponse().equals("correta")) {
            
          JOptionPane.showMessageDialog(null, "Resposta correta! ");
          if(jButton1.getText().equals(response)) {
           jButton1.setBackground(Color.GREEN);
           return true;
          }
          if(jButton2.getText().equals("Banana")) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        var setColor = VerifyResponses(jButton1.getText());
        /*
        if(setColor == false) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        var setColor = VerifyResponses(jButton2.getText());
       /* 
        if(setColor == false) {
            jButton2.setBackground(Color.red);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        var setColor = VerifyResponses(jButton3.getText());
       /* 
        if(setColor == false) {
