...
public class QuestionOneForm extends javax.swing.JFrame {
    ...
    private void VerifyResponses(String response){
        ArrayList arrCorrectQuestions  = new ArrayList<String>();
        ...
        if(confirmation == 0) {
         try{
           ...
           Questions question = new Questions(correctResponse,responseList);
        
          if(question.verifyResponse().equals("correta")) {     
                JOptionPane.showMessageDialog(null, "Resposta correta! "); 
                arrCorrectQuestions.add("c");
        }
        else{
         ...
         if(jButton1.getText().equals(correctResponse)) {
          ...
          if(jButton2.getText().equals(correctResponse)) {
                jButton2.setBackground(Color.GREEN);
                jButton1.setBackground(Color.red);
                jButton4.setBackground(Color.red);
                
          }
          if(jButton4.getText().equals(correctResponse)) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       VerifyResponses(jButton1.getText());
      
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        VerifyResponses(jButton2.getText());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        conn.runConnection();
        try{
         ResultSet rs =  conn.SelectAll("SELECT * FROM game");
         if(rs.next()) {
